...
#         # losses_dict_pd.index=pd.RangeIndex(12)
#         # indexes = [12, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700,
#         #            1800, 1900, 2000]
#
#         losses_dict_pd.to_csv('../losses_log_4_hist.csv')
#
